  ...
  <div>
    ...
    <el-card>
      ...
      <el-table :data="orderlist" border stripe>
        ...
        <el-table-column label="操作" width="150px">
          <template>
            ...
            <!-- 物流 -->
            <el-button size="mini" type="success" icon="el-icon-location" @click="locationBtn"></el-button>
          </template>
        </el-table-column>
      </el-table>
      ...
      <el-dialog title="修改地址" :visible.sync="editDialogVisible" width="50%" @close="addressDialogClose">
        <el-form :model="edieForm" :rules="edieRules" ref="edieFormRef" label-width="100px">
          <el-form-item label="省市区/县" prop="cityName">
            <el-cascader :options="CityData" v-model="edieForm.cityName"></el-cascader>
          </el-form-item>

          <el-form-item label="详细地址" prop="address">
            <el-input v-model="edieForm.address"></el-input>
          </el-form-item>
        </el-form>
...
export default {
  data() {
    return {
      ...
      // 修改表单的验证规则
      edieRules: {
        cityName: [{ required: true, message: '请输入选择省市区县', trigger: 'blur' }],
  ...
  methods: {
    ...
    addressDialogClose() {
      this.$refs.edieFormRef.resetFields()
    },
    // 点击定位按钮事件
    locationBtn() {
